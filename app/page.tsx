...
function EmailView({ state, localData }: { state: OperationsState; localData: ReturnType<typeof useFieldsteadLocalJobs> }) {
  ...
  const [intakeReview, setIntakeReview] = useState<{ proposal: EmailIntakeReviewProposal; mode: EmailIntakeReviewMode; draft?: EmailIntakeDraft; approval: EmailIntakeApproval; operationId?: string; result?: { customerId?: string; serviceRequestId?: string; replayed: boolean } }>();
