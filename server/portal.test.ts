...
import { getPortalResource, listPortalResource } from './portal-service';
...
async function fixture() {
  ...
  db.portalEstimates.push({ id: 'estimate-1', organization_id: 'org-1', customer_id: 'customer-1', job_id: 'job-1', estimate_number: 'EST-1001', status: 'sent', subtotal_cents: 25000, issued_at: '2026-09-24T00:00:00.000Z', internal_notes: 'margin target 42%', created_by_user_id: 'private-user', updated_at: '2026-09-24T00:00:00.000Z' });
